...
public class DeliveryTime {
	...
	public static void main(String[] args) {
		LocalDateTime deliveryTime = getInputAndCalculateDeliveryTime();
		System.out.println("Delivery DateandTime::" + deliveryTime);
	}

	public static LocalDateTime getInputAndCalculateDeliveryTime() {
		...
		return user.addtime(currentTime);
	}
...
class User {
	...
	public User(List<String> destination, List<LocalTime> time) {
		super();
