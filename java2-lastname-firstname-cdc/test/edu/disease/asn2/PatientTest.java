...
public class PatientTest {
    ...
    @Test
    void testCompareTo_NullLastName() {
        // Create a patient with a null last name and another with a non-null last name
        Patient patient1 = new Patient(5, 10);
        patient1.setFirstName("Kosi");

        Patient patient2 = new Patient(5, 10);
        patient2.setFirstName("Sakthi");
        patient2.setLastName("K");

        // Ensure that the patient with a non-null last name is considered greater
